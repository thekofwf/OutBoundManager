...
<script type="text/javascript">
	...
	document.write("<script type='text/javascript'  src='" + getHref('manager/js/workMain_Accordion.js') + "'></s" + "cript>");
	document.write("<script type='text/javascript'  src='" + getHref('manager/js/workMain_Api.js') + "'></s" + "cript>");
	document.write("<script type='text/javascript'  src='" + getHref('manager/js/workMain_Tab.js') + "'></s" + "cript>");

	document.write("<script type='text/javascript'  src='" + getHref('manager/js/workMain.js') + "'></s" + "cript>");
</script>
