...
<script type="text/javascript">
	...
	document.write("<scr" + "ipt type='text/javascript'  src='" + getHref('admin.js') + "'></s" + "cript>");
</script>
...
<body onload="initialize()">
	...
	<div id="divLogin" style="width: 250px; height: 200px">
		<table>
			...
			<tr>
				<td colspan="2" style="text-align: center; font-size: 40">外拨管理后台</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td style="text-align: left"><a id="btn" href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'icon-add'" onclick="doLogin()">登录</a></td>
			</tr>
		</table>
	</div>
	<div style="display: none;">
		<form name="loginForm" method="post">
			<input type="text" class="easyui-textbox" id="agentId" name="agentId" value="" /> <input type="text" class="easyui-textbox" id="userInfo" name="userInfo" value="" />
		</form>
	</div>
</body>
</html>